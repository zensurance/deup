...
const getPackageFiles = () => sync("**/package.json", {
    ignore: ["**/node_modules/**/package.json", "package.json"],
})

const removeDupes = async (packageFiles, packageName) => {
    let maxVersion = ""
...
const addToRootAndInstall = async (packageName, maxVersion) => {
...
const dedupe = async (packageName) => {
    try {
